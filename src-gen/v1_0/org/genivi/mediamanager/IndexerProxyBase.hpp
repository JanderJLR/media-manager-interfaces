 ...
 */
#ifndef ORG_GENIVI_MEDIAMANAGER_Indexer_PROXY_BASE_HPP_
#define ORG_GENIVI_MEDIAMANAGER_Indexer_PROXY_BASE_HPP_
...
public:
    typedef CommonAPI::ObservableReadonlyAttribute<::v1_0::org::genivi::mediamanager::Indexer::IndexerStatus> IndexerStatusAttribute;
    ...
    virtual std::future<CommonAPI::CallStatus> getDatabasePathAsync(GetDatabasePathAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
    ...
    virtual std::future<CommonAPI::CallStatus> stopIndexingAsync(StopIndexingAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
    ...
    virtual std::future<CommonAPI::CallStatus> startIndexingAsync(StartIndexingAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr) = 0;
};
...
#endif // ORG_GENIVI_MEDIAMANAGER_Indexer_PROXY_BASE_HPP_
