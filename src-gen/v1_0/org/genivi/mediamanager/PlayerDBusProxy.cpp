...
*/
#include <v1_0/org/genivi/mediamanager/PlayerDBusProxy.hpp>
...
,		mute_(*this, "onMuteAttributeChanged", "setMuteAttribute", "i", "getMuteAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		...
		position_(*this, "t", "getPositionAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		duration_(*this, "onDurationAttributeChanged", "t", "getDurationAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr))
{
         ...
         */
        void PlayerDBusProxy::next(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
                >,
                CommonAPI::DBus::DBusSerializableArguments<
                    CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError,CommonAPI::EmptyDeployment>
                >
            >::callMethodWithReply(
            *this,
            "next",
        ...
        std::future<CommonAPI::CallStatus> PlayerDBusProxy::nextAsync(NextAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
            ...
            *this,
            ...
            "",
            (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
            [_callback] (CommonAPI::CallStatus _status, CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> _e) {
            	_callback(_status, _e.getValue());
            },
         ...
         */
        void PlayerDBusProxy::openUri(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
         ...
         */
        void PlayerDBusProxy::enqueueUri(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> deploy_uri(_uri, static_cast<CommonAPI::DBus::StringDeployment*>(nullptr));
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
         ...
         */
        void PlayerDBusProxy::dequeueIndex(const uint64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
         ...
         */
        void PlayerDBusProxy::getCurrentPlayQueue(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::MediaTypes::ResultMapList &_playQueue, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::MediaTypes::ResultMapList, ::v1_0::org::genivi::mediamanager::MediaTypes_::ResultMapListDeployment_t> deploy_playQueue(static_cast<::v1_0::org::genivi::mediamanager::MediaTypes_::ResultMapListDeployment_t*>(nullptr));
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
                >,
        ...
        std::future<CommonAPI::CallStatus> PlayerDBusProxy::getCurrentPlayQueueAsync(GetCurrentPlayQueueAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
            ...
            *this,
            ...
            "",
            (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
            [_callback] (CommonAPI::CallStatus _status, CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::MediaTypes::ResultMapList, ::v1_0::org::genivi::mediamanager::MediaTypes_::ResultMapListDeployment_t> _playQueue, CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> _e) {
            	_callback(_status, _playQueue.getValue(), _e.getValue());
            },
         ...
         */
        void PlayerDBusProxy::dequeueAll(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
                >,
         ...
         *               NO_ERROR     On success
         */
        void PlayerDBusProxy::openPlaylist(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> deploy_uri(_uri, static_cast<CommonAPI::DBus::StringDeployment*>(nullptr));
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
         ...
         *   this has no effect
         */
        void PlayerDBusProxy::pause(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
                >,
         ...
         */
        void PlayerDBusProxy::play(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
                >,
         ...
         * see: Pause
         */
        void PlayerDBusProxy::playPause(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
                >,
         ...
         */
        void PlayerDBusProxy::previous(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
                >,
         ...
         * see: Next
         */
        void PlayerDBusProxy::seek(const int64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
         ...
         */
        void PlayerDBusProxy::setPosition(const uint64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
            CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_pos(_pos, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::Deployable<::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError, CommonAPI::EmptyDeployment> deploy_e(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
            CommonAPI::DBus::DBusProxyHelper<
                CommonAPI::DBus::DBusSerializableArguments<
