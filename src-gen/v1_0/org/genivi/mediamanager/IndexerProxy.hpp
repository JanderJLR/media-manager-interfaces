 ...
 */
#ifndef ORG_GENIVI_MEDIAMANAGER_Indexer_PROXY_HPP_
#define ORG_GENIVI_MEDIAMANAGER_Indexer_PROXY_HPP_
...
public:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     */
    virtual std::future<CommonAPI::CallStatus> getDatabasePathAsync(GetDatabasePathAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> stopIndexingAsync(StopIndexingAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> startIndexingAsync(StartIndexingAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
...
struct DefaultAttributeProxyHelper<::v1_0::org::genivi::mediamanager::IndexerProxy,
    _AttributeExtension> {
    typedef typename ::v1_0::org::genivi::mediamanager::IndexerProxy<
            ::v1_0::org::genivi::mediamanager::IndexerExtensions::IndexerStatusAttributeExtension<_AttributeExtension>
    > class_t;
};
}

#endif // ORG_GENIVI_MEDIAMANAGER_Indexer_PROXY_HPP_
