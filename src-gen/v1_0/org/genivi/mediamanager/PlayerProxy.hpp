...
*/
#ifndef ORG_GENIVI_MEDIAMANAGER_Player_PROXY_HPP_
#define ORG_GENIVI_MEDIAMANAGER_Player_PROXY_HPP_
...
public:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void next(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     */
    virtual std::future<CommonAPI::CallStatus> nextAsync(NextAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void openUri(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> openUriAsync(const std::string &_uri, OpenUriAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void enqueueUri(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> enqueueUriAsync(const std::string &_uri, EnqueueUriAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void dequeueIndex(const uint64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> dequeueIndexAsync(const uint64_t &_pos, DequeueIndexAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void getCurrentPlayQueue(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::MediaTypes::ResultMapList &_playQueue, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> getCurrentPlayQueueAsync(GetCurrentPlayQueueAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void dequeueAll(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> dequeueAllAsync(DequeueAllAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void openPlaylist(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> openPlaylistAsync(const std::string &_uri, OpenPlaylistAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void pause(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> pauseAsync(PauseAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void play(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void playPause(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> playPauseAsync(PlayPauseAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void previous(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> previousAsync(PreviousAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void seek(const int64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> seekAsync(const int64_t &_pos, SeekAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void setPosition(const uint64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> setPositionAsync(const uint64_t &_pos, SetPositionAsyncCallback _callback, const CommonAPI::CallInfo *_info = nullptr);
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::next(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::openUri(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::enqueueUri(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::dequeueIndex(const uint64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::getCurrentPlayQueue(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::MediaTypes::ResultMapList &_playQueue, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::dequeueAll(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::openPlaylist(const std::string &_uri, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::pause(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::play(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::playPause(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::previous(CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::seek(const int64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void PlayerProxy<_AttributeExtensions...>::setPosition(const uint64_t &_pos, CommonAPI::CallStatus &_internalCallStatus, ::v1_0::org::genivi::mediamanager::PlayerTypes::PlayerError &_e, const CommonAPI::CallInfo *_info) {
...
struct DefaultAttributeProxyHelper<::v1_0::org::genivi::mediamanager::PlayerProxy,
    _AttributeExtension> {
    typedef typename ::v1_0::org::genivi::mediamanager::PlayerProxy<
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::MuteAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::ShuffleAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::RepeatAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::RateAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::VolumeAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::CanGoNextAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::CanGoPreviousAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::CanPauseAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::CanPlayAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::CanSeekAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::CurrentTrackAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::PlaybackStatusAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::PositionAttributeExtension<_AttributeExtension>, 
            ::v1_0::org::genivi::mediamanager::PlayerExtensions::DurationAttributeExtension<_AttributeExtension>
    > class_t;
};
}

#endif // ORG_GENIVI_MEDIAMANAGER_Player_PROXY_HPP_
