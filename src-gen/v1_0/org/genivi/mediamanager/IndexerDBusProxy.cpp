 ...
 */
#include <v1_0/org/genivi/mediamanager/IndexerDBusProxy.hpp>
...
,		indexerStatus_(*this, "onIndexerStatusAttributeChanged", "i", "getIndexerStatusAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr))
{
        ...
        std::future<CommonAPI::CallStatus> IndexerDBusProxy::getDatabasePathAsync(GetDatabasePathAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
            ...
            *this,
            ...
            "",
            (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
            [_callback] (CommonAPI::CallStatus _status, CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> _output, CommonAPI::Deployable<Indexer::IndexerError, CommonAPI::EmptyDeployment> _e) {
            	_callback(_status, _output.getValue(), _e.getValue());
            },
        ...
        std::future<CommonAPI::CallStatus> IndexerDBusProxy::stopIndexingAsync(StopIndexingAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
            ...
            *this,
            ...
            "",
            (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
            [_callback] (CommonAPI::CallStatus _status, CommonAPI::Deployable<Indexer::IndexerError, CommonAPI::EmptyDeployment> _e) {
